...
void BaseModule::initialize(const int control_cycle_msec, robotis_framework::Robot *robot)
{
       ...
       it != robot->dxls_.end(); it++)
  {
    ...
    // TODO. creo que aquí es donde se escribe a los Dynamixel
...
// TODO. Ésta es la función que controla los motores, ya la que escribe las posiciones, pero no
// encuentro que es lo publica para hacerlo :'v aiuda
